...
<head>
  ...
  <title>P.PHUKA HERB - เพิ่มประเภทสินค้า<</title>
      ...
      <div class="card shadow mb-4" width="800">
        ...
        <div class="card-body">
          <div class="form-group">
            <form action="./process/category-add.php" method="post" enctype="multipart/form-data">
              <div class="form-group row">
                <div class="col-sm-6 mb-3 mb-sm-0">
                  <label class="m-0 font-weight-bold text-warning">ชื่อประเภทสินค้า</label>
                  <input type="text" class="form-control form-control-user" id="exampleInputctg_type" placeholder="ชื่อประเภทสินค้า" name="ctg_type" value="" required="">
                </div>
               <!--  <div class="col-sm-6">
