...
if ($uploadOk == 3) {
	...
	$m_detail = isset($_POST["m_detail"])?$_POST["m_detail"]:'';
  $m_no = isset($_POST["m_no"])?$_POST["m_no"]:'';



    $sql = "INSERT INTO material (m_name,m_detail,m_no,m_img)
    VALUES ('$m_name','$m_detail','$m_no','$file_name') ";
    ...
    if ($result) {
      ...
      echo "
        ...
        window.location.href ='../material-add.php';
        </script>
        ";
  }
