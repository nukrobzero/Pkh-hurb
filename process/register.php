...
if($user_password == $user_repassword) {
	...
	if ($result_u->num_rows > 0) {
		...
		$sql = "INSERT INTO users (user_id,user_pre_name,user_last_name,user_username,user_password,user_email)
		VALUES ('$id_insert','$user_pre_name','$user_last_name','$user_username','$user_password','$user_email') ";
