        ...
        <div class="card-body">
          <div class="form-group">
            ...
            <form action="#" method="post">
              ...
              <br>
              <br>
               <a href="./profile-index-edit.php?user_id=<?php echo $user_id; ?>"><button class="btn btn-primary btn-user btn-block"type="button">
                แก้ไข
              </button></a>
              <hr>
              <a href="./index.php"><button class="btn btn-success btn-user btn-block" type="button">
                ย้อนกลับ
              </button></a>                  
            </form>
          </div>    
