...
<head>
  ...
  <title>P.PHUKA HERB - แก้ไขประเภทสินค้า<</title>
    ...
    <div class="container pl-1">
      ...
      <div class="card shadow mb-4" width="800">
        <div class="card-header py-3">
          <h4 class="m-0 font-weight-bold text-primary">แก้ไขประเภทสินค้า</h4>
        </div>
        <div class="card-body">
          <?php 
          $ctg_id = htmlspecialchars( isset($_GET['ctg_id'])?$_GET['ctg_id']:'');
          $sql = "SELECT * FROM category WHERE ctg_id = $ctg_id";
          ...
          <div class="form-group">
            <form action="./process/category-edit.php?ctg_id=<?php echo $ctg_id; ?>" method="post">
              <div class="form-group row">
                <div class="col-sm-6 mb-3 mb-sm-0">
                  <label class="m-0 font-weight-bold text-warning">ชื่อประเภทสินค้า</label>
                  <input type="text" class="form-control form-control-user" id="exampleInputctg_type" placeholder="" name="ctg_type" value="<?php echo $row["ctg_type"]; ?>" required="">
                </div>
              </div>
              <br>
              <br>
