...
<head>
  ...
  <title>P.PHUKA HERB - เพิ่มโปรโมชั่น</title>
            ...
            <div class="card shadow mb-4" width="800">
              ...
              <div class="card-body">
                <div class="form-group">
                  <form action="./process/promotions-add.php" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                      <label class="m-0 font-weight-bold text-warning">ชื่อโปรโมชั่น</label>
                      <input type="text" class="form-control form-control-user" id="exampleInputp_title" placeholder="" name="p_title" value="" required="">
                    </div>
                    <div class="form-group row">
                      <div class="col-sm-6 mb-3 mb-sm-0">
                        <label class="m-0 font-weight-bold text-warning">ลดกี่ %</label>
                        <input type="number" class="form-control form-control-user" id="examplep_percent" placeholder="" name="p_percent" value="" required="">
                      </div>
                      <div class="col-sm-6">
                        <label class="m-0 font-weight-bold text-warning">ราคา/บาท</label>
                        <input type="number" class="form-control form-control-user" id="examplep_bath" placeholder="" name="p_bath" value="" required="">
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-sm-6 mb-3 mb-sm-0">
