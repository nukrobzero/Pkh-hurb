...
<head>
  ...
  <title>P.PHUKA HERB - แก้ไขข้อมูลสูตรการผลิต</title>
    ...
    <div class="container pl-1">
      ...
      <div class="card shadow mb-4" width="800">
        <div class="card-header py-3">
          <h4 class="m-0 font-weight-bold text-primary">แก้ไขข้อมูลสูตรการผลิต</h4>
        </div>
        <div class="card-body">
            ...
            <form action="./process/material-cal-edit.php?material_cal_id=<?php echo $material_cal_id; ?>" method="post" enctype="multipart/form-data">
              <div class="form-group row">
                <div class="col-sm-6 mb-3 mb-sm-0">
                  ...
                  <input type="text" class="form-control form-control-user" id="exampleInputm_detail" placeholder="ชื่อสูตรการผลิต" name="material_cal_name" value="<?php echo $row1["material_cal_name"]; ?>" required="">
                </div>                  
                <div class="col-sm-6">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control form-control-user" id="exampleInputm_detail" placeholder="รายละเอียดสินค้า..." name="material_cal_detail" value="<?php echo $row1["material_cal_detail"]; ?>">
              </div>
              ...
              ?>
              <input type="radio" class="form-control-label" name="material_cal_or_not" id="material_cal_or_not1" value="1" <?php echo $checked; ?> > มี</input>
              <input type="radio" class="form-control-label" name="material_cal_or_not" id="material_cal_or_not0" value="0" <?php echo $checked2; ?> > ไม่มี</input>
              <hr>
              ...
              <div id="material-group">
                ...
                <div class="form-inline">
                  <input type='number' placeholder='จำนวน' class='form-control' name='packeting-no' id="packeting-no" >
        ...
        $("#amount").val(0);
          ...
          function textAmount(amount){
            ...
            for (var i = 0; i < parseInt(amount); i++) {
              ...
              tmptext+= "<input type='number' step='any' placeholder='ส่วนผสมที่ใช้ (กรัม)' class='form-control form-control-user' id = 'mp_unit"+i+"' name='mp_unit[]' value='"+tmp_mt_unit[i]+"'>";
              tmptext+= "</div>";
              tmptext+= "<div  class='col-sm-2'>";
              tmptext+= "<input type='number' step='any' placeholder='ราคาส่วนผสมที่ใช้ (บาท)' class='form-control form-control-user' id = 'mp_price"+i+"' name='mp_price[]' value='"+tmp_mt_price[i]+"'>";
              tmptext+= "</div>";
              tmptext+= "<div  class='col-sm-3'>";
              tmptext+= "<input type='number' step='any' placeholder='ส่วนผสมที่ได้ต่อ 1 ขวด' class='form-control form-control-user' id = 'mp_volume"+i+"' name='mp_volume[]' value='"+tmp_mt_volume[i]+"'>";
              tmptext+= "</div>";
              tmptext+= "</div>";
            } 
            return tmptext;
