              ...
              <div class="card-body">
                <div class="form-group">
                 ...
                 if ($result->num_rows > 0) {
                  ...
                  $cate_promotion = $row1["promo_id"];
                  $cate_category = $row1["ctg_id"];
                } else {
                  echo "0 results";
                }
                ?>
                <form method="post" action="./process/products-edit-img.php?pd_id=<?php echo $pd_id; ?>" enctype="multipart/form-data">
                  <div class="form-group row">
                    <div class="col-12 mb-3 mb-sm-0 text-center">
                      <img src="./img/uploads/products/<?php echo $row1["pd_img"]; ?>" height="200" ><br>
                      <br>
                ...
                <form action="./process/products-edit.php?pd_id=<?php echo $pd_id; ?>" method="post" >
                  <br>
                  <hr>
                  <br>
                  <div class="form-group">
                    <label class="m-0 font-weight-bold text-warning">ชื่อสินค้า</label>
                    <input type="text" class="form-control form-control-user" id="exampleInputpd_name" placeholder="" name="pd_name" value="<?php echo $row1["pd_name"]; ?>" required="">
                  </div>
                  <div class="form-group row">
                    <div class="col-sm-6 mb-3 mb-sm-0">
                      ...
                      <select  class="form-control form-control-user" name="ctg_type" >
                        ...
                        if ($result->num_rows > 0) {
                          ...
                          {
                            if ($row["ctg_id"]==$cate_category){
                              $selected = 'selected';
                            }
                            else{
                              $selected = '';
                            }
                            echo '<option value="'.$row["ctg_id"].'"'.$selected.'>'.$row["ctg_type"].'</option>';
                          }   
                        } else {
                          echo "0 results";
                        }
                  ...
                  <div class="form-group">
                    ...
                    <textarea type="text" class="form-control form-control-user" id="exampleInputpd_detail" placeholder="" name="pd_detail" required=""><?php echo $row1["pd_detail"];  ?></textarea>
                  </div>
                  <br>
                  <br>
